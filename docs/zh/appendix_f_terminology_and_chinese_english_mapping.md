...
术语表的作用也不只是“翻译”。在数据工程、治理、评测、Agent 和隐私技术这些主题里，很多词看起来像同义词，实际上却有明确边界。比如“脱敏”“匿名化”“可用”“可发布”并不是一回事；“联邦学习”“隐私增强技术”“安全多方计算”也不是随便互换的。词用错了，读者就会把工程约束误读成法律结论，或者把研究原型误读成生产方案。对于人工智能基本概念和术语，ISO/IEC 22989:2022 提供了标准化参照；本附录则在此基础上给出更贴近本书工程语境的中文主称。
...
数据卡片、模型卡片和数据集说明不是本书临时创造的说法，而是延续了 Datasheets for Datasets、Model Cards 和 Data Cards 中对数据与模型文档化的讨论（Gebru et al. 2021; Mitchell et al. 2019; Pushkarna et al. 2022）。因此，术语表中保留这些主词，是为了让正文、附录和外部文献之间能够稳定互相定位。
